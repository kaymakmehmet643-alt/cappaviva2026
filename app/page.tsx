...
// 1. INSTAGRAM BİLEŞENİNİ BURADA İÇE AKTARDIK (EKLENDİ)
// Not: Eğer hata alırsan '@/components/instagram' yerine '../components/instagram' yapabilirsin.
...
export default function Home() {
  ...
  return (
   ...
   {/* ======================================================= */}
      {/* 8. INSTAGRAM BÖLÜMÜ (BİLEŞEN BURAYA EKLENDİ)            */}
      {/* ======================================================= */}
      <div className="py-24 bg-white relative">
        ...
        {/* --- DİNAMİK INSTAGRAM BİLEŞENİNİ BURADA ÇAĞIRIYORUZ --- */}
