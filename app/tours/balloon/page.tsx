      ...
      <div className="relative h-[60vh] w-full">
        ...
        <div className="absolute bottom-0 w-full z-20 p-8 bg-gradient-to-t from-black/90 to-transparent text-white">
          <div className="max-w-5xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-extrabold mb-4 drop-shadow-lg">Hot Air Balloon Flight</h1>
            ...
            <div className="flex flex-wrap items-center gap-6">
              <span className="text-3xl font-bold text-yellow-500">From €150</span>
